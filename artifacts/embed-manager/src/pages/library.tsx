  ...
  return (
    <div className="flex flex-col h-full bg-background relative">
      <div className="border-b flex flex-col sm:flex-row sm:items-center px-4 md:px-6 py-3 md:py-0 md:h-16 gap-2 sm:gap-4 shrink-0 bg-card">
        <h1 className="text-lg md:text-xl font-bold flex-1">All Embeds</h1>
      ...
      <div className="flex-1 overflow-auto p-3 md:p-6">
        {isLoading ? (
                    ...
                    {selectionMode && (
                      <div className="absolute top-2 left-2 z-10 bg-background/80 rounded backdrop-blur-sm p-1">
                        <Checkbox 
                          ...
                          // The card click handles the toggle, but we keep this for visual sync
                          readOnly
                        />
                      </div>
                    )}
          ...
          <div className="flex flex-col items-center justify-center h-64 text-center">
            ...
            <h3 className="text-base md:text-lg font-medium">No embeds found</h3>
            <p className="text-muted-foreground text-sm max-w-xs mt-1">
              Try adjusting your search or add some new embeds to your library.
            </p>
          </div>
        )}
      </div>
